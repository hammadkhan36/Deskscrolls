...
//   // Fetch authors for filter dropdown
//   const { data: authors } = await supabase.from('profiles').select('id, full_name').order('full_name')
...
//       <PostFilters currentStatus={status} currentAuthor={authorId} authors={authors ?? []} />
