...
// //           {title}
// //         </h3>
// //         <p className="mt-1 text-base text-gray-500 font-normal">
// //           {subtitle}
// //         </p>
// //       </div>
// //     </div>
...
//   altText = "Workspace setup"
// }: BlogCardProps) {
//   // Agar imageUrl nahi diya, to fallback use karein
...
//           sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
//           onError={() => {
//             // Agar image load fail hui, to fallback image set karein
