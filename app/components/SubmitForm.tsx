...
//       setFormData({ email: '', name: '', twitter: '' });
//     }, 1500);
//   };
...
//             Show us your workspace for a chance to be featured in the Workspaces community ✨
//           </h1>
//           <p className="text-gray-600 text-sm md:text-base mt-3 leading-relaxed">
//             There is currently a backlog to be featured. Please fill out the form below and we'll be in touch as soon as possible.
//           </p>
//         </div>
...
//                 className="w-full rounded-md bg-gray-50 border border-gray-200 px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-gray-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-gray-400 transition"
//               />
//             </div>
...
//             {/* Twitter Handle */}
//             <div>
//               <label htmlFor="twitter" className="block text-sm font-semibold text-gray-800 mb-1.5">
...
//               className="w-full bg-black text-white font-semibold py-3.5 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition disabled:opacity-70 disabled:cursor-not-allowed"
//             >
...
//             {/* Success Message */}
//             {message && (
//               <div className="mt-4 text-center text-green-600 text-sm font-medium bg-green-50 p-3 rounded-md border border-green-200">
//                 {message}
//               </div>
//             )}
//           </form>
